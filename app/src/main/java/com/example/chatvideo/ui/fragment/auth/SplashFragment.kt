...
import com.example.chatvideo.databinding.FragmentSplashBinding
import com.example.chatvideo.ui.viewmodel.auth.SplashState
import com.example.chatvideo.ui.viewmodel.auth.SplashViewModel
        ...
        viewModel.liveData.observe(requireActivity()) {
            when (it) {
                is SplashState.MainActivity -> {
                    val isSign =
                        Constant.getSharePref(requireContext()).getBoolean(Constant.SIGNIN, false)
                    if (isSign)
